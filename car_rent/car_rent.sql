...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2019 at 12:09 PM
...
CREATE TABLE `car` (
  `license_plate` varchar(250) COLLATE utf8_hungarian_ci NOT NULL,
  `make` varchar(250) COLLATE utf8_hungarian_ci NOT NULL,
  `model` varchar(250) COLLATE utf8_hungarian_ci NOT NULL,
  `kw` float NOT NULL,
  `ccm` int(11) NOT NULL,
  `km` int(11) NOT NULL,
  `transmission` tinyint(1) DEFAULT NULL,
  `price_per_hour` float NOT NULL DEFAULT 1000,
  `price_per_km` float DEFAULT 10,
  `category` varchar(250) COLLATE utf8_hungarian_ci DEFAULT NULL,
  `type` varchar(250) COLLATE utf8_hungarian_ci DEFAULT NULL,
  `status` varchar(250) COLLATE utf8_hungarian_ci NOT NULL DEFAULT 'Available'
...
INSERT INTO `car` (`license_plate`, `make`, `model`, `kw`, `ccm`, `km`, `transmission`, `price_per_hour`, `price_per_km`, `category`, `type`, `status`) VALUES
('ABC123', 'Fiat', 'Punto', 44, 1261, 169000, 0, 800, 0, '', '', 'Available'),
('BCD123', 'Audi', 'A8', 120, 2496, 120000, 1, 1870, 0, 'Luxury', 'Sedan', 'Available'),
('BCD188', 'Toyota', 'Yaris', 48, 998, 110000, 0, 580, 0, 'Economic', '', 'Available');
...
CREATE TABLE `car_status` (
  `id` int(11) NOT NULL,
  `name_en` varchar(255) COLLATE utf8_hungarian_ci NOT NULL,
  `name_hu` varchar(255) COLLATE utf8_hungarian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;
...
INSERT INTO `car_status` (`id`, `name_en`, `name_hu`) VALUES
(1, 'Available', 'Elérhető'),
(2, 'Rented out', 'Kibérelve'),
(3, 'Unavailable', 'Nem elérhető');
...
INSERT INTO `category` (`id`, `name_en`, `name_hu`) VALUES
(1, 'Economy', 'Gazdaságos'),
(2, 'Standard', 'Normál'),
(3, 'Intermediate', 'Felső-közép osztály'),
(4, 'Elegance', 'Elegáns'),
(5, 'Luxury', 'Luxus');
...
CREATE TABLE `country` (
  `id` int(11) NOT NULL,
  `hu` varchar(75) COLLATE utf8_hungarian_ci NOT NULL DEFAULT '',
  `en` varchar(75) COLLATE utf8_hungarian_ci NOT NULL DEFAULT '',
  `alpha_2` char(2) COLLATE utf8_hungarian_ci NOT NULL DEFAULT '',
  `alpha_3` char(3) COLLATE utf8_hungarian_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;
...
INSERT INTO `country` (`id`, `hu`, `en`, `alpha_2`, `alpha_3`) VALUES
(4, 'Afganisztán', 'Afghanistan', 'af', 'afg'),
(8, 'Albánia', 'Albania', 'al', 'alb'),
(12, 'Algéria', 'Algeria', 'dz', 'dza'),
(20, 'Andorra', 'Andorra', 'ad', 'and'),
(24, 'Angola', 'Angola', 'ao', 'ago'),
(28, 'Antigua és Barbuda', 'Antigua and Barbuda', 'ag', 'atg'),
(31, 'Azerbajdzsán', 'Azerbaijan', 'az', 'aze'),
(32, 'Argentína', 'Argentina', 'ar', 'arg'),
(36, 'Ausztrália', 'Australia', 'au', 'aus'),
(40, 'Ausztria', 'Austria', 'at', 'aut'),
(44, 'Bahama-szigetek', 'Bahamas', 'bs', 'bhs'),
(48, 'Bahrein', 'Bahrain', 'bh', 'bhr'),
(50, 'Banglades', 'Bangladesh', 'bd', 'bgd'),
(51, 'Örményország', 'Armenia', 'am', 'arm'),
(52, 'Barbados', 'Barbados', 'bb', 'brb'),
(56, 'Belgium', 'Belgium', 'be', 'bel'),
(64, 'Bhután', 'Bhutan', 'bt', 'btn'),
(68, 'Bolívia', 'Bolivia (Plurinational State of)', 'bo', 'bol'),
(70, 'Bosznia-Hercegovina', 'Bosnia and Herzegovina', 'ba', 'bih'),
(72, 'Botswana', 'Botswana', 'bw', 'bwa'),
(76, 'Brazília', 'Brazil', 'br', 'bra'),
(84, 'Belize', 'Belize', 'bz', 'blz'),
(90, 'Salamon-szigetek', 'Solomon Islands', 'sb', 'slb'),
(96, 'Brunei', 'Brunei Darussalam', 'bn', 'brn'),
(100, 'Bulgária', 'Bulgaria', 'bg', 'bgr'),
(104, 'Mianmar', 'Myanmar', 'mm', 'mmr'),
(108, 'Burundi', 'Burundi', 'bi', 'bdi'),
(112, 'Fehéroroszország', 'Belarus', 'by', 'blr'),
(116, 'Kambodzsa', 'Cambodia', 'kh', 'khm'),
(120, 'Kamerun', 'Cameroon', 'cm', 'cmr'),
(124, 'Kanada', 'Canada', 'ca', 'can'),
(132, 'Zöld-foki Köztársaság', 'Cabo Verde', 'cv', 'cpv'),
(140, 'Közép-Afrika', 'Central African Republic', 'cf', 'caf'),
(144, 'Srí Lanka', 'Sri Lanka', 'lk', 'lka'),
(148, 'Csád', 'Chad', 'td', 'tcd'),
(152, 'Chile', 'Chile', 'cl', 'chl'),
(156, 'Kína', 'China', 'cn', 'chn'),
(170, 'Kolumbia', 'Colombia', 'co', 'col'),
(174, 'Comore-szigetek', 'Comoros', 'km', 'com'),
(178, 'Kongói Köztársaság (Kongó)', 'Congo', 'cg', 'cog'),
(180, 'Kongói Demokratikus Köztársaság (Zaire)', 'Congo, Democratic Republic of the', 'cd', 'cod'),
(188, 'Costa Rica', 'Costa Rica', 'cr', 'cri'),
(191, 'Horvátország', 'Croatia', 'hr', 'hrv'),
(192, 'Kuba', 'Cuba', 'cu', 'cub'),
(196, 'Ciprus', 'Cyprus', 'cy', 'cyp'),
(203, 'Csehország', 'Czechia', 'cz', 'cze'),
(204, 'Benin', 'Benin', 'bj', 'ben'),
(208, 'Dánia', 'Denmark', 'dk', 'dnk'),
(212, 'Dominikai Közösség', 'Dominica', 'dm', 'dma'),
(214, 'Dominikai Köztársaság', 'Dominican Republic', 'do', 'dom'),
(218, 'Ecuador', 'Ecuador', 'ec', 'ecu'),
(222, 'Salvador', 'El Salvador', 'sv', 'slv'),
(226, 'Egyenlítői-Guinea', 'Equatorial Guinea', 'gq', 'gnq'),
(231, 'Etiópia', 'Ethiopia', 'et', 'eth'),
(232, 'Eritrea', 'Eritrea', 'er', 'eri'),
(233, 'Észtország', 'Estonia', 'ee', 'est'),
(242, 'Fidzsi', 'Fiji', 'fj', 'fji'),
(246, 'Finnország', 'Finland', 'fi', 'fin'),
(250, 'Franciaország', 'France', 'fr', 'fra'),
(262, 'Dzsibuti', 'Djibouti', 'dj', 'dji'),
(266, 'Gabon', 'Gabon', 'ga', 'gab'),
(268, 'Grúzia', 'Georgia', 'ge', 'geo'),
(270, 'Gambia', 'Gambia', 'gm', 'gmb'),
(276, 'Németország', 'Germany', 'de', 'deu'),
(288, 'Ghána', 'Ghana', 'gh', 'gha'),
(296, 'Kiribati', 'Kiribati', 'ki', 'kir'),
(300, 'Görögország', 'Greece', 'gr', 'grc'),
(308, 'Grenada', 'Grenada', 'gd', 'grd'),
(320, 'Guatemala', 'Guatemala', 'gt', 'gtm'),
(324, 'Guinea', 'Guinea', 'gn', 'gin'),
(328, 'Guyana', 'Guyana', 'gy', 'guy'),
(332, 'Haiti', 'Haiti', 'ht', 'hti'),
(340, 'Honduras', 'Honduras', 'hn', 'hnd'),
(348, 'Magyarország', 'Hungary', 'hu', 'hun'),
(352, 'Izland', 'Iceland', 'is', 'isl'),
(356, 'India', 'India', 'in', 'ind'),
(360, 'Indonézia', 'Indonesia', 'id', 'idn'),
(364, 'Irán', 'Iran (Islamic Republic of)', 'ir', 'irn'),
(368, 'Irak', 'Iraq', 'iq', 'irq'),
(372, 'Írország', 'Ireland', 'ie', 'irl'),
(376, 'Izrael', 'Israel', 'il', 'isr'),
(380, 'Olaszország', 'Italy', 'it', 'ita'),
(384, 'Elefántcsontpart', 'Côte d\'Ivoire', 'ci', 'civ'),
(388, 'Jamaica', 'Jamaica', 'jm', 'jam'),
(392, 'Japán', 'Japan', 'jp', 'jpn'),
(398, 'Kazahsztán', 'Kazakhstan', 'kz', 'kaz'),
(400, 'Jordánia', 'Jordan', 'jo', 'jor'),
(404, 'Kenya', 'Kenya', 'ke', 'ken'),
(408, 'Észak-Korea (Koreai NDK)', 'Korea (Democratic People\'s Republic of)', 'kp', 'prk'),
(410, 'Dél-Korea (Koreai Köztársaság)', 'Korea, Republic of', 'kr', 'kor'),
(414, 'Kuvait', 'Kuwait', 'kw', 'kwt'),
(417, 'Kirgizisztán', 'Kyrgyzstan', 'kg', 'kgz'),
(418, 'Laosz', 'Lao People\'s Democratic Republic', 'la', 'lao'),
(422, 'Libanon', 'Lebanon', 'lb', 'lbn'),
(426, 'Lesotho', 'Lesotho', 'ls', 'lso'),
(428, 'Lettország', 'Latvia', 'lv', 'lva'),
(430, 'Libéria', 'Liberia', 'lr', 'lbr'),
(434, 'Líbia', 'Libya', 'ly', 'lby'),
(438, 'Liechtenstein', 'Liechtenstein', 'li', 'lie'),
(440, 'Litvánia', 'Lithuania', 'lt', 'ltu'),
(442, 'Luxemburg', 'Luxembourg', 'lu', 'lux'),
(450, 'Madagaszkár', 'Madagascar', 'mg', 'mdg'),
(454, 'Malawi', 'Malawi', 'mw', 'mwi'),
(458, 'Malajzia', 'Malaysia', 'my', 'mys'),
(462, 'Maldív-szigetek', 'Maldives', 'mv', 'mdv'),
(466, 'Mali', 'Mali', 'ml', 'mli'),
(470, 'Málta', 'Malta', 'mt', 'mlt'),
(478, 'Mauritánia', 'Mauritania', 'mr', 'mrt'),
(480, 'Mauritius', 'Mauritius', 'mu', 'mus'),
(484, 'Mexikó', 'Mexico', 'mx', 'mex'),
(492, 'Monaco', 'Monaco', 'mc', 'mco'),
(496, 'Mongólia', 'Mongolia', 'mn', 'mng'),
(498, 'Moldova', 'Moldova, Republic of', 'md', 'mda'),
(499, 'Montenegró', 'Montenegro', 'me', 'mne'),
(504, 'Marokkó', 'Morocco', 'ma', 'mar'),
(508, 'Mozambik', 'Mozambique', 'mz', 'moz'),
(512, 'Omán', 'Oman', 'om', 'omn'),
(516, 'Namíbia', 'Namibia', 'na', 'nam'),
(520, 'Nauru', 'Nauru', 'nr', 'nru'),
(524, 'Nepál', 'Nepal', 'np', 'npl'),
(528, 'Hollandia', 'Netherlands', 'nl', 'nld'),
(548, 'Vanuatu', 'Vanuatu', 'vu', 'vut'),
(554, 'Új-Zéland', 'New Zealand', 'nz', 'nzl'),
(558, 'Nicaragua', 'Nicaragua', 'ni', 'nic'),
(562, 'Niger', 'Niger', 'ne', 'ner'),
(566, 'Nigéria', 'Nigeria', 'ng', 'nga'),
(578, 'Norvégia', 'Norway', 'no', 'nor'),
(583, 'Mikronézia', 'Micronesia (Federated States of)', 'fm', 'fsm'),
(584, 'Marshall-szigetek', 'Marshall Islands', 'mh', 'mhl'),
(585, 'Palau', 'Palau', 'pw', 'plw'),
(586, 'Pakisztán', 'Pakistan', 'pk', 'pak'),
(591, 'Panama', 'Panama', 'pa', 'pan'),
(598, 'Pápua Új-Guinea', 'Papua New Guinea', 'pg', 'png'),
(600, 'Paraguay', 'Paraguay', 'py', 'pry'),
(604, 'Peru', 'Peru', 'pe', 'per'),
(608, 'Fülöp-szigetek', 'Philippines', 'ph', 'phl'),
(616, 'Lengyelország', 'Poland', 'pl', 'pol'),
(620, 'Portugália', 'Portugal', 'pt', 'prt'),
(624, 'Bissau-Guinea', 'Guinea-Bissau', 'gw', 'gnb'),
(626, 'Kelet-Timor', 'Timor-Leste', 'tl', 'tls'),
(634, 'Katar', 'Qatar', 'qa', 'qat'),
(642, 'Románia', 'Romania', 'ro', 'rou'),
(643, 'Oroszország', 'Russian Federation', 'ru', 'rus'),
(646, 'Ruanda', 'Rwanda', 'rw', 'rwa'),
(659, 'Saint Kitts és Nevis', 'Saint Kitts and Nevis', 'kn', 'kna'),
(662, 'Saint Lucia', 'Saint Lucia', 'lc', 'lca'),
(670, 'Saint Vincent és a Grenadine-szigetek', 'Saint Vincent and the Grenadines', 'vc', 'vct'),
(674, 'San Marino', 'San Marino', 'sm', 'smr'),
(678, 'São Tomé és Príncipe', 'Sao Tome and Principe', 'st', 'stp'),
(682, 'Szaúd-Arábia', 'Saudi Arabia', 'sa', 'sau'),
(686, 'Szenegál', 'Senegal', 'sn', 'sen'),
(688, 'Szerbia', 'Serbia', 'rs', 'srb'),
(690, 'Seychelle-szigetek', 'Seychelles', 'sc', 'syc'),
(694, 'Sierra Leone', 'Sierra Leone', 'sl', 'sle'),
(702, 'Szingapúr', 'Singapore', 'sg', 'sgp'),
(703, 'Szlovákia', 'Slovakia', 'sk', 'svk'),
(704, 'Vietnám', 'Vietnam', 'vn', 'vnm'),
(705, 'Szlovénia', 'Slovenia', 'si', 'svn'),
(706, 'Szomália', 'Somalia', 'so', 'som'),
(710, 'Dél-afrikai Köztársaság', 'South Africa', 'za', 'zaf'),
(716, 'Zimbabwe', 'Zimbabwe', 'zw', 'zwe'),
(724, 'Spanyolország', 'Spain', 'es', 'esp'),
(728, 'Dél-Szudán', 'South Sudan', 'ss', 'ssd'),
(729, 'Szudán', 'Sudan', 'sd', 'sdn'),
(740, 'Suriname', 'Suriname', 'sr', 'sur'),
(748, 'Szváziföld', 'Eswatini', 'sz', 'swz'),
(752, 'Svédország', 'Sweden', 'se', 'swe'),
(756, 'Svájc', 'Switzerland', 'ch', 'che'),
(760, 'Szíria', 'Syrian Arab Republic', 'sy', 'syr'),
(762, 'Tádzsikisztán', 'Tajikistan', 'tj', 'tjk'),
(764, 'Thaiföld', 'Thailand', 'th', 'tha'),
(768, 'Togo', 'Togo', 'tg', 'tgo'),
(776, 'Tonga', 'Tonga', 'to', 'ton'),
(780, 'Trinidad és Tobago', 'Trinidad and Tobago', 'tt', 'tto'),
(784, 'Egyesült Arab Emírségek', 'United Arab Emirates', 'ae', 'are'),
(788, 'Tunézia', 'Tunisia', 'tn', 'tun'),
(792, 'Törökország', 'Turkey', 'tr', 'tur'),
(795, 'Türkmenisztán', 'Turkmenistan', 'tm', 'tkm'),
(798, 'Tuvalu', 'Tuvalu', 'tv', 'tuv'),
(800, 'Uganda', 'Uganda', 'ug', 'uga'),
(804, 'Ukrajna', 'Ukraine', 'ua', 'ukr'),
(807, 'Macedónia', 'North Macedonia', 'mk', 'mkd'),
(818, 'Egyiptom', 'Egypt', 'eg', 'egy'),
(826, 'Egyesült Királyság', 'United Kingdom of Great Britain and Northern Ireland', 'gb', 'gbr'),
(834, 'Tanzánia', 'Tanzania, United Republic of', 'tz', 'tza'),
(840, 'Amerikai Egyesült Államok', 'United States of America', 'us', 'usa'),
(854, 'Burkina Faso', 'Burkina Faso', 'bf', 'bfa'),
(858, 'Uruguay', 'Uruguay', 'uy', 'ury'),
(860, 'Üzbegisztán', 'Uzbekistan', 'uz', 'uzb'),
(862, 'Venezuela', 'Venezuela (Bolivarian Republic of)', 've', 'ven'),
(882, 'Szamoa', 'Samoa', 'ws', 'wsm'),
(887, 'Jemen', 'Yemen', 'ye', 'yem'),
(894, 'Zambia', 'Zambia', 'zm', 'zmb');
...
INSERT INTO `rent_status` (`id`, `name_en`, `name_hu`) VALUES
(1, 'Processing', 'Feldolgozás alatt'),
(2, 'Approved', 'Jóváhagyva'),
(3, 'Ready for pickup', 'Átvehető'),
(4, 'Rented out', 'Kibérelve'),
(5, 'Completed', 'Teljesítve'),
(6, 'Canceled', 'Visszavonva'),
(7, 'Denied', 'Megtagadva');
...
INSERT INTO `type` (`id`, `name_en`, `name_hu`) VALUES
(1, 'Sedan', 'Lépcsőshátú'),
(2, 'Hatchback', 'Csapott Hátú'),
(3, 'Wagon', 'Kombi'),
(4, 'Mini Van', 'Kisbusz'),
(5, 'SUV', 'SUV'),
(6, 'Jeep', 'Terepjáró');
...
CREATE TABLE `user` (
  ...
  `psw` text COLLATE utf8_hungarian_ci NOT NULL,
...
INSERT INTO `user` (`id`, `user_name`, `del`, `email`, `auth`, `psw`, `token`) VALUES
('', 'admin', NULL, 'admin@example.com', 9, '$2y$10$zNtabb9hBHNmNQ/684lyMOsWl.XgRExPewHzBLSusFLbu60MCkrqK', '5dee06eed10121.52697506');
